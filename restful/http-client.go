...
func init() {
	...
	container.Filter(requestFilter)
	WebContainer = container
}

func requestFilter(request *restful.Request, response *restful.Response, chain *restful.FilterChain) {
	log.Printf("Path : %s , client ip : %s", request.Request.RequestURI, request.Request.RemoteAddr)
